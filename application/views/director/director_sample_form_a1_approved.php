    ...
    <div id="wrapper">
        ...
        <div id="sidebar-wrapper">
            <ul class="sidebar-nav">
                ...
                <li>
                    <a href="director_approve.php" class="active"><span class="glyphicon glyphicon-star" aria-hidden="true"></span>&nbsp Approved Proposals</a>
                </li>
                <li>
                    <a href="director_reviews.php"><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span>&nbsp Reviewed Proposals</a>
                </li>
                <li>
                    ...
                    <div>
                        ...
                        <div class="panel" align="center">
                            <div class="panel-body"><p>
                                  <h2>Barangay Labangon River Clean-up</h2>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4" align="center">
                          <a href="director_approve.php" style="text-decoration:none">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4" align="center">
                          <button type="button" class="btn btn-lg btn-success btn-block"><span class="glyphicon glyphicon-book" aria-hidden="true"></span>&nbsp Convert to PDF</button>
                        </div>
                    </div>
                </div>
            </div>
