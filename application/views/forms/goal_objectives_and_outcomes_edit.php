	...
	<div class="panel panel-success">
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
              <textarea class="form-control" rows="5" name="goal_objectives_and_outcomes" data-toggle="tooltip" placeholder="Type Here..."><?php echo $result_ab['goal_objectives_and_outcomes']; ?></textarea>  
            </div>
        </div>
    </div>
</body>
