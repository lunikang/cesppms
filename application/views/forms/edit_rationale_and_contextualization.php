	...
	<div class="panel panel-success">
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
              <textarea class="form-control" rows="5" name="rationale_and_contextualization" data-toggle="tooltip" placeholder="Type Here..." <?php if (isset($proposal['rationale_and_contextualization'])) { echo 'value=" ' . nl2br($proposal['rationale_and_contextualization']).'"'; } ?>"></textarea>
            </div>
        </div>
    </div>
</body>
