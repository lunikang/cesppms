	...
	<div class="panel panel-success">
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
              <textarea class="form-control" rows="5" name="participants_partners_and_beneficiaries" data-toggle="tooltip" placeholder="Type Here..."><?php echo $result_ab['participants_partnersand_beneficiaries']; ?></textarea>  
            </div>
        </div>
    </div>
</body>
