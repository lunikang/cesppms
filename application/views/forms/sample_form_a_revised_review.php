                ...
                <div class="row tab-content">
                    <div>
                        ...
                        <div class="panel panel-success">
                          ...
                          <div class="panel-body">
                            ...
                            <div class="text-success">
                              <table>
                                <tr>
                                  <td><span class="glyphicon glyphicon-check" aria-hidden="true"></span>&nbsp Department Chair notes revised CES proposal</td>
                                </tr>
                                <tr>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4" align="center">
                          <a href="coordinator_review.php" style="text-decoration:none"><button type="button" class="btn btn-lg btn-danger btn-block"><span class="glyphicon glyphicon-hand-left" aria-hidden="true"></span>&nbsp Back</button></a>
                        </div>
