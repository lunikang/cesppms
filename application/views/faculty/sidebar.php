            ...
            <ul class="sidebar-nav">
                ...
                <li>
                  <div align="center">
                    ...
                    <h5 class="designation">CES Faculty</h5>
                  </div>
                </li>
                <li>
                    <a href="<?php echo site_url('Faculty/home');?>"><span class="glyphicon glyphicon-folder-open" aria-hidden="true"></span>&nbsp My Proposals</a>
                </li>
                <li>
                    <a href="<?php echo site_url('Faculty/account_settings');?>"><span class="glyphicon glyphicon-cog" aria-hidden="true"></span>&nbsp Account Settings</a>
                </li>
                <li>
