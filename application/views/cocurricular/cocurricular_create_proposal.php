                            ...
                            <div class="panel panel-success">
                                ...
                                <table class="table table-bordered" width="100%">
                                    <tr>
                                        ...
                                        <td width="30%">
                                            <a href="<?php echo site_url('CoCurricular/form_a_1?form_type=1');?>" style="text-decoration:none">
                                    ...
                                    <tr>
                                        <table class="table table-bordered" width="100%">
                                            ...
                                            <tr>
                                                ...
                                                <td width="30%">
                                                    <a href="<?php echo site_url('CoCurricular/form_a');?>" style="text-decoration:none">
                                                        <button type="button" class="btn btn-success btn-block btn-lg" >Proceed &nbsp<span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span></button>
                                                    </a>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td width="30%">
                                                    <a href="<?php echo site_url('CoCurricular/form_c');?>" style="text-decoration:none">
